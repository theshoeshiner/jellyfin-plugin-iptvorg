...
using Jellyfin.Plugin.Iptvorg.Configuration;
...
{
    internal class ServerEntryPoint : IHostedService
    {
        ...
        public ServerEntryPoint(ILogger<ServerEntryPoint> logger, ILibraryManager libManager, ITaskManager taskManager)
        {
            _logger = logger;
